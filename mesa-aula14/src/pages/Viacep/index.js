        ...
        {this.state.dados && (
          <ul className="list-group list-group-flush">
            <li className="list-group-item">
              <p>Logradouro: <strong>{this.state.dados.logradouro}</strong></p>
            </li>
            <li className="list-group-item">
              <p>Bairro: <strong>{this.state.dados.bairro}</strong></p>
            </li>
            <li className="list-group-item">
              <p>Cidade: <strong>{this.state.dados.localidade}</strong></p>
            </li>
            <li className="list-group-item">
              <p>Estado: <strong>{this.state.dados.uf}</strong></p>
            </li>
          </ul>
        )
        }
